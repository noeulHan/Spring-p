...
<div class=text-left style="margin: 0px 0px 0px 80px;">
	...
	<a href="${ctp}/dbShop/dbMyOrder4"><font style="font-size: 14px;">이벤트 응모내역</font></a>  
</div><br/>
<div style="width: 1500px; margin: 0 auto;" class="text-center">
 	<div style="width: 100%;">
		...
		<div class="float33" id="float2" style="width:80%; height:1000px; padding:30px;">
			<div class="text-left" style="font-family: 'Noto Sans KR', sans-serif; font-size: 30px; padding-left: 50px;"><b>이벤트 응모내역</b></div><hr/><br/><br/><br/>
			<img src="${ctp}/images/home/K-913.jpg"><br/><br/><br/>
			<div class="text-center" style=" font-size: 15px; font-family: 'Noto Sans KR', sans-serif;">응모한 이벤트가 없습니다.</div><br/><br/><br/><br/><hr/>
		</div>
	</div>
</div>
<div id="float3"></div> 
