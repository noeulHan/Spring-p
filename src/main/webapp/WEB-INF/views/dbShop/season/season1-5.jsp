...
<div class=text-left style="margin: 0px 0px 0px 80px;">
	...
	<a href="${ctp}/dbShop/season1-5"><font style="font-size: 14px;">데상트 우먼스 위크 여성용 상품 추가 10% OFF</font></a>  
</div><br/>
<div style="padding-left: 80px; padding-right: 120px; margin-bottom: 0px;">
	<font style="font-size: 12pt; font-family: 'Gantari', sans-serif;">2022.08.01 ~ 2022.08.20</font>
</div><br/><br/>
<div class="text-center"><img src="${ctp}/images/season/7127_DETAIL_PC_KOR_20220729174108.jpg" width="110%"/></div><br/>
