...
<div class=text-left style="margin: 0px 0px 0px 80px;">
	...
	<a href="${ctp}/dbShop/season1-1"><font style="font-size: 14px;">22S/S 시즌 할인전 봄여름 신상품 최대 50% 할인</font></a>  
</div><br/>
<div style="padding-left: 80px; padding-right: 120px; margin-bottom: 0px;">
	<font style="font-size: 12pt; font-family: 'Gantari', sans-serif;">2022.06.20 ~ 2022.08.31</font>
</div><br/><br/>
<img src="${ctp}/images/season/6641_DETAIL_PC_KOR_20220617150027.jpg" width="100%"/><br/><br/><br/>
