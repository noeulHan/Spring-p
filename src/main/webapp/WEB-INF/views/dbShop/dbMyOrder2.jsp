...
<div style="width: 1500px; margin: 0 auto;" class="text-center">
 	<div style="width: 100%;">
		...
		<div class="text-left" style="font-family: 'Noto Sans KR', sans-serif; font-size: 30px; padding-left: 50px;"><b>환불계좌 관리</b></div><hr/><br/><br/><br/>
			<img src="${ctp}/images/home/K-913.jpg"><br/><br/><br/>
			<div class="text-center" style=" font-size: 15px; font-family: 'Noto Sans KR', sans-serif;">등록된 환불계좌가 없습니다.</div><br/><br/><br/><br/><hr/>
			<button class="btn btn-secondary-outline" style="font-family: 'Noto Sans KR', sans-serif; background-color:#c2935f; color: white; width: 200px; height: 50px;">환불 계좌 등록</button>
		</div>
	</div>
</div>
<div id="float3"></div> 
