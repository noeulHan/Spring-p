...
<head>
  <meta charset="UTF-8">
  <title>dbShoptContent.jsp(관리자 상품정보 상세보기)</title>
    ...
    <div class="col p-3 text-center">
		...
		<div class="col p-3 text-left">
		  ...
		  <div class="text-center">
		    <button class="btn btn-secondary-outline" style="font-family: 'Noto Sans KR', sans-serif; background-color:#c2935f; color: white; width: 200px; height: 60px;" onclick="history.back()">돌아가기</button>&nbsp;
		  </div>
		</div>
  </div>
  <br/><br/><br/><br/><br/>
