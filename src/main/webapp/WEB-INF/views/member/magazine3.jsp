...
<div style="width: 90%; margin: 0 auto;" class="text-center">
	<div class="w3-row-padding w3-padding-16 w3-center" id="lookbook">
	  <div class="w3-quarter">
	    <a href="${ctp}/member/magazine3-5"><img src="${ctp}/images/magazine/룩북2-1.jpg" alt="룩북2-1" style="width:100%"></a><br/><br/>
	  ...
	  <div class="w3-quarter">
	    <a href="${ctp}/member/magazine3-6"><img src="${ctp}/images/magazine/룩북2-2.jpg" alt="룩북2-2" style="width:100%"></a><br/><br/>
	  ...
	  <div class="w3-quarter">
	    <a href="${ctp}/member/magazine3-7"><img src="${ctp}/images/magazine/룩북2-3.jpg" alt="룩북2-3" style="width:100%"></a><br/><br/>
	  ...
	  <div class="w3-quarter">
	    <a href="${ctp}/member/magazine3-8"><img src="${ctp}/images/magazine/룩북2-4.jpg" alt="룩북2-4" style="width:100%"></a><br/><br/>
...
<div style="width: 90%; margin: 0 auto;" class="text-center">
	<div class="w3-row-padding w3-padding-16 w3-center" id="lookbook">
	  <div class="w3-quarter">
	    <a href="${ctp}/member/magazine3-9"><img src="${ctp}/images/magazine/룩북3-1.jpg" alt="룩북3-1" style="width:100%"></a><br/><br/>
	    <div class="text-left"><font style="font-weight: 500; font-size: 18pt; font-family: 'Gantari', sans-serif;">Since 1922 르미너</font></div>
	  </div>
	  <div class="w3-quarter">
	    <a href="${ctp}/member/magazine3-10"><img src="${ctp}/images/magazine/룩북3-2.jpg" alt="룩북3-2" style="width:100%"></a><br/><br/>
	  ...
	  <div class="w3-quarter">
	    <a href="${ctp}/member/magazine3-11"><img src="${ctp}/images/magazine/룩북3-3.jpg" alt="룩북3-3" style="width:100%"></a><br/><br/>
	  ...
	  <div class="w3-quarter">
	    <a href="${ctp}/member/magazine3-12"><img src="${ctp}/images/magazine/룩북3-4.jpg" alt="룩북3-4" style="width:100%"></a><br/><br/>
...
<div style="width: 90%; margin: 0 auto;" class="text-center">
	<div class="w3-row-padding w3-padding-16 w3-center" id="lookbook">
	  <div class="w3-quarter">
	    <a href="${ctp}/member/magazine3-13"><img src="${ctp}/images/magazine/룩북4-1.jpg" alt="룩북4-1" style="width:100%"></a><br/><br/>
	    <div class="text-left"><font style="font-weight: 500; font-size: 18pt; font-family: 'Gantari', sans-serif;">SJYP 22SS LOOKBOOK</font></div>
	  </div>
	  <div class="w3-quarter">
	    <a href="${ctp}/member/magazine3-14"><img src="${ctp}/images/magazine/룩북4-2.jpg" alt="룩북4-2" style="width:100%"></a><br/><br/>
	    <div class="text-left"><font style="font-weight: 500; font-size: 18pt; font-family: 'Gantari', sans-serif;">CK x NO:ZE</font></div>
	  </div>
	  <div class="w3-quarter">
	    <a href="${ctp}/member/magazine3-15"><img src="${ctp}/images/magazine/룩북4-3.jpg" alt="룩북4-3" style="width:100%"></a><br/><br/>
	  ...
	  <div class="w3-quarter">
	    <a href="${ctp}/member/magazine3-16"><img src="${ctp}/images/magazine/룩북4-4.jpg" alt="룩북4-4" style="width:100%"></a><br/><br/>
