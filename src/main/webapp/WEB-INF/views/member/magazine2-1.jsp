...
<a href="${ctp}/member/magazine2-1"><font style="font-size: 14px;">린넨 스타일링 가이드</font></a>
</div><br/>
<div class="text-left"><font style="margin-left:80px; font-family: 'Noto Sans KR', sans-serif; font-size: 17pt; color:black;">린넨 스타일링 가이드</font><br/><font style="margin-left:80px; font-family: 'Noto Sans KR', sans-serif; color:#777777; font-size: 12pt;">가볍고 시원한 소재 린넨 스타일링 제안</font></div><br/>
<img src="${ctp}/images/magazine/스타일상세샷1.jpg" width="100%"/><br/><br/><br/>
