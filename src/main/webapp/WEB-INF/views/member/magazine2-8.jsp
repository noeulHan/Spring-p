...
<a href="${ctp}/member/magazine2-8"><font style="font-size: 14px;">WE ARE PLUS&CURVE</font></a>
</div><br/>
<div class="text-left"><font style="margin-left:80px; font-family: 'Noto Sans KR', sans-serif; font-size: 17pt; color:black;">WE ARE PLUS&CURVE</font><br/><font style="margin-left:80px; font-family: 'Noto Sans KR', sans-serif; color:#777777; font-size: 12pt;">플러스 사이즈를 위한 타미힐피거 / 타미진스의 플러스 사이즈 라인</font></div><br/>
<img src="${ctp}/images/magazine/스타일상세샷8.jpg" width="100%"/><br/><br/><br/>
