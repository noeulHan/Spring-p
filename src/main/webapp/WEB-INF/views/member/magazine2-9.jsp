...
<a href="${ctp}/member/magazine2-9"><font style="font-size: 14px;">여름 라운딩에 뭘 입지?</font></a>
</div><br/>
<div class="text-left"><font style="margin-left:80px; font-family: 'Noto Sans KR', sans-serif; font-size: 17pt; color:black;">여름 라운딩에 뭘 입지?</font><br/><font style="margin-left:80px; font-family: 'Noto Sans KR', sans-serif; color:#777777; font-size: 12pt;">인플루언서들이 택한 여름 골프 라운딩 룩</font></div><br/>
<img src="${ctp}/images/magazine/스타일상세샷9.jpg" width="100%"/><br/><br/><br/>
