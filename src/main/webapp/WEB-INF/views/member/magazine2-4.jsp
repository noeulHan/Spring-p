...
<a href="${ctp}/member/magazine2-4"><font style="font-size: 14px;">HELLO! MY BEACH</font></a>
</div><br/>
<div class="text-left"><font style="margin-left:80px; font-family: 'Noto Sans KR', sans-serif; font-size: 17pt; color:black;">HELLO! MY BEACH</font><br/><font style="margin-left:80px; font-family: 'Noto Sans KR', sans-serif; color:#777777; font-size: 12pt;">다시 돌아온 뜨거운 여름, 그리고 써머 바캉스 룩</font></div><br/>
<img src="${ctp}/images/magazine/스타일상세샷4.jpg" width="100%"/><br/><br/><br/>
