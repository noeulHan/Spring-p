...
<a href="${ctp}/member/magazine2-6"><font style="font-size: 14px;">젤라비 PICK!</font></a>
</div><br/>
<div class="text-left"><font style="margin-left:80px; font-family: 'Noto Sans KR', sans-serif; font-size: 17pt; color:black;">젤라비 PICK!</font><br/><font style="margin-left:80px; font-family: 'Noto Sans KR', sans-serif; color:#777777; font-size: 12pt;">따라 입고 싶은 SJYPxTHENCE의 그래픽 티셔츠 스타일링</font></div><br/>
<img src="${ctp}/images/magazine/스타일상세샷6.jpg" width="100%"/><br/><br/><br/>
