...
<a href="${ctp}/member/magazine2-2"><font style="font-size: 14px;">터치 마이 BAG 💚</font></a>
</div><br/>
<div class="text-left"><font style="margin-left:80px; font-family: 'Noto Sans KR', sans-serif; font-size: 17pt; color:black;">터치 마이 BAG 💚</font><br/><font style="margin-left:80px; font-family: 'Noto Sans KR', sans-serif; color:#777777; font-size: 12pt;">설쁘 염설희의 PICK! 덱케 썸머백 </font></div><br/>
<img src="${ctp}/images/magazine/스타일상세샷2.jpg" width="100%"/><br/><br/><br/>
