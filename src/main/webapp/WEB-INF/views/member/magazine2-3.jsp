...
<a href="${ctp}/member/magazine2-3"><font style="font-size: 14px;">써머 백 앤 슈즈</font></a>
</div><br/>
<div class="text-left"><font style="margin-left:80px; font-family: 'Noto Sans KR', sans-serif; font-size: 17pt; color:black;">써머 백 앤 슈즈</font><br/><font style="margin-left:80px; font-family: 'Noto Sans KR', sans-serif; color:#777777; font-size: 12pt;">여름에 완벽한 백앤슈즈 컬렉션</font></div><br/>
<img src="${ctp}/images/magazine/스타일상세샷3.jpg" width="100%"/><br/><br/><br/>
