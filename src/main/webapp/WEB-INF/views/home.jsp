...
<div class="text-center"><font style="font-family: 'Gantari', sans-serif; font-size: 30pt; color:black;">BRAND NEW</font></div><br/>
<div class="text-right" style="padding-bottom: 15px; padding-right:200px; font-family: 'Noto Sans KR', sans-serif;"><a href="${ctp}/dbShop/dbProductList">전체보기 ></a></div>
<!-- 덱케 데이터 슬라이드 -->
<div class="text-center" style="font-family: 'Gantari', sans-serif; width: 1800px; margin: 0 auto; padding:0px 100px 15px 100px;">
	  <span id="menu"><a href="${ctp}/"><b>ALL </b></a>⠀⠀</span>
	  <c:forEach var="mainTitle" items="${mainTitleVos}" varStatus="st">
	  	<span id="menu1"><a href="${ctp}/?part=${mainTitle.categoryMainName}"><b>${mainTitle.categoryMainName}</b></a></span>
...
<div style="width: 1500px; margin: 0 auto;" class="text-center" >
	<div class="slider-leftone" id="slider-leftone" style=" height:500px;">
	  ...
	  <a href="${ctp}/dbShop/dbProductContent?idx=${vo2.idx}">
	    <img height="408px;" style="margin-bottom: 5px;" src="${ctp}/dbShop/product/${vo2.FSName}" width="260px;" id="productImgR"/>
		...
		<div class="w3-row">
			<div class="w3-col m7">
				...
				<%-- 	<div style="color: #e4e4e4; font-family: 'Gantari', sans-serif; background-color: black; padding:0px 100px 15px 100px;">
					 	<span><a href="${ctp}/dbShop/dbProductList">ALL </a>⠀|⠀</span>
					  <c:forEach var="mainTitle" items="${mainTitleVos}" varStatus="st">
					  	<span><a href="${ctp}/dbShop/dbProductList?part=${mainTitle.categoryMainName}">${mainTitle.categoryMainName}</a></span>
						  <c:if test="${!st.last}">⠀|⠀</c:if>
					  </c:forEach><br/>
					</div> --%>
					<div class="text-center" style="font-size:25pt; padding-top: 40px; padding-bottom: 15px; padding-left:40px; font-family: 'Gantari', sans-serif;"><b>TOMMY HILFIGER</b></div>
					...
					<div class="slider-left1">
						<div style="width: 253px; height: 500px; margin-left: 50px; margin-right: 50px;"><a href="${ctp}/dbShop/dbProductContent?idx=168"><img style="width: 253px; height: 394px;" src="${ctp}/images/home/q1GM0122071170712_1_ORGINL.jpg">TOMMY HILFIGER<br/><font style="font-family:'Noto Sans KR', sans-serif;">베이비 크롭 시그니쳐 티셔츠</font><br/><br/>82,000원</a></div>
						<div style="width: 253px; height: 394px; margin-left: 50px; margin-right: 50px;"><a href="${ctp}/dbShop/dbProductContent?idx=169"><img style="width: 253px; height: 394px;" src="${ctp}/images/home/3GM0122071471576_1_ORGINL.jpg">TOMMY HILFIGER<br/><font style="font-family:'Noto Sans KR', sans-serif;">코어 스트레치 슬림 크루넥 티셔츠</font><br/><br/>66,000원</a></div>
						<div style="width: 253px; height: 394px; margin-left: 50px; margin-right: 50px;"><a href="${ctp}/dbShop/dbProductContent?idx=170"><img style="width: 253px; height: 394px;" src="${ctp}/images/home/2GM0122071270955_1_ORGINL.jpg">TOMMY HILFIGER<br/><font style="font-family:'Noto Sans KR', sans-serif;">핏 앤 플레어 슬리브리스 데님 드레스</font><br/><br/>238,000원</a></div>
						 <%-- <c:forEach var="vo2" items="${productVos2}">
								<div style="text-align:left; font-size:9pt; font-family: 'Noto Sans KR', sans-serif; margin-left: 10px; margin-right: 10px;">
							  <a href="${ctp}/dbShop/dbProductContent?idx=${vo2.idx}">
			...
			<div class="w3-col m5">
				<div class="slider-right1">
					<div style="width: 716px; height: 716px;"><a href="${ctp}/dbShop/season1-5"><img src="${ctp}/images/home/K-854.jpg" width="716px;" height="716px;"></a></div>
				</div>
			</div>
		</div>
	</div><br/><br/><br/><br/>
<div style="padding-left: 80px; padding-right: 80px;"></div>
	...
	<div class="text-center" style="font-size:25pt; padding-top: 40px; padding-bottom: 15px; padding-left:40px; font-family: 'Gantari', sans-serif;"><b>SHOP</b></div><br/>
