...
<div class=text-left style="margin: 0px 0px 0px 80px;">
	...
	<a href="${ctp}/option/event2-4"><font style="font-size: 14px;">타미힐피거 프로그램 'MY TOMMY'</font></a>  
</div><br/><br/>
<div style="padding-left: 120px; padding-right: 120px; margin-bottom: 0px;">
	<font style="font-size: 12pt; font-family: 'Gantari', sans-serif;">2022.05.20 ~ 2022.08.31</font>
</div>	
<br/><img src="${ctp}/images/option/이벤트상세8.jpg" width="100%"/><br/><br/><br/>
