...
<div class=text-left style="margin: 0px 0px 0px 80px;">
	...
	<a href="${ctp}/option/event3-1"><font style="font-size: 14px;">NEW E 패션몰 멤버십 혜택</font></a>  
</div><br/><br/>
...
<br/><img src="${ctp}/images/option/이벤트상세9.jpg" width="100%"/><br/><br/><br/>
