...
<div class=text-left style="margin: 0px 0px 0px 80px;">
	...
	<a href="${ctp}/option/event1-4"><font style="font-size: 14px;">E패션몰 8월 출석체크</font></a>  
</div><br/><br/>
...
<br/><img src="${ctp}/images/option/이벤트상세4.jpg" width="100%"/><br/><br/><br/>
