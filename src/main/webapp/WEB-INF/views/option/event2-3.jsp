...
<div class=text-left style="margin: 0px 0px 0px 80px;">
	...
	<a href="${ctp}/option/event2-3"><font style="font-size: 14px;">카카오톡 플러스친구 이벤트</font></a>  
</div><br/><br/>
<div style="padding-left: 120px; padding-right: 120px; margin-bottom: 0px;">
	<font style="font-size: 12pt; font-family: 'Gantari', sans-serif;">2022.03.01 ~ 2023.02.28</font>
</div>	
<br/><img src="${ctp}/images/option/이벤트상세7.jpg" width="100%"/><br/><br/><br/>
