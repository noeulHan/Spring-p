...
<div class=text-left style="margin: 0px 0px 0px 80px;">
	...
	<a href="${ctp}/option/event1-3"><font style="font-size: 14px;">앱으로 떠나는 E캉스</font></a>  
</div><br/><br/>
...
<br/><img src="${ctp}/images/option/이벤트상세3.jpg" width="100%"/><br/><br/><br/>
