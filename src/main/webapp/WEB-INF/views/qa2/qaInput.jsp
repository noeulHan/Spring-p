	  ...
	  <table class="table">
	    ...
	    <tr>
	      ...
	      <div class="input-group-append">
					<select name="caseone" class="custom-select">
					  ...
					  <option value="환불/배송">환불/배송</option>
					  <option value="회원/혜택">회원/혜택</option>
					  <option value="포인트/쿠폰">포인트/쿠폰</option>
					  <option value="모바일App">모바일App</option>
					</select>
				</div>
				 </td>
	    </tr>
	    ...
	    <tr>
	      <td colspan="2" class="text-center">
	        ...
	        <input type="button" value="돌아가기" onclick="location.href='${ctp}/qa2/qaMain2';" class="btn btn-outline-secondary"/>
	      </td>
	    </tr>
	  </table>
