...
<br/>
<div class="text-center"><input type="button" value="돌아가기" onclick="location.href='qaMain2?pag=${pag}&pageSize=${pageSize}';" class="btn" style="background-color:#c2935f; color: white;"/></div>
<p><br/></p><p><br/></p>
