...
public class KakaoServiceImpl implements KakaoService {
  ...
  public String getAccessToken(String code) {
    ...
    try {
      ...
      sb.append("&client_id=47a8628946e7c2ba0c980cc9799fa8c7");
      sb.append("&redirect_uri=http://localhost:9090/javagreenS_hne/kakao/kakaoMain");
			/*
			 * sb.append(
			 * "&redirect_uri=http://http://49.142.157.251:9090/javagreenS_hne/kakao/kakaoMain"
			 * );
			 */
      sb.append("&code="+code);
