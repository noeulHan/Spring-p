...
public interface DbShopDAO {
	...
	public List<DbBaesongVO> getMyOrderStatus(@Param("startIndexNo") int startIndexNo, @Param("pageSize") int pageSize, @Param("mid") String mid, @Param("startJumun") String startJumun, @Param("endJumun") String endJumun);
	...
	public List<DbProductVO> getCategoryMain2();
	...
	public List<DbProductVO> getDbShopList2(@Param("startIndexNo") int startIndexNo, @Param("pageSize") int pageSize, @Param("dbcase") String dbcase);

	public int totSearchRecCnt(@Param("part") String part);

	public int totRecCnt();

	public List<DbProductVO> getMainTitle();

	public List<DbProductVO> getDbShopListMain(@Param("startIndexNo") int startIndexNo, @Param("pageSize") int pageSize, @Param("part") String part);

	public List<DbProductVO> getSeason1(@Param("brand") String brand);

	public List<DbProductVO> getSeason2(@Param("brand") String brand);

	public int totSearchRecCnt2(@Param("part") String part);

	public int totRecCnt2(@Param("mid") String mid, @Param("conditionDate") int conditionDate);

	public int totRecCntMyOrderStatus(@Param("mid") String mid, @Param("startJumun") String startJumun, @Param("endJumun") String endJumun);
